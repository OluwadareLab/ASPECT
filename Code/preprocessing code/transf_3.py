...
data = np.genfromtxt("../datasets/strictEST/3'exon.csv", delimiter=',', dtype=object, skip_header=1, usecols=range(13), encoding='cp1252')
...
with open(output_file, 'w') as f:
    ...
    for row in filtered_data:
        ...
        # Write the data row to the output file
        writer.writerow(['4',  seq1_data+seq2_data])
